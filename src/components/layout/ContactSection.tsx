...
const ContactSection = () => {
  ...
  return (
    <section ref={sectionRef} className="relative py-20 md:py-28 overflow-hidden flex justify-center items-center">
      {/* Dot grid decorations */}
      <div className="container relative z-10 px-6 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          {/* Left Content */}
          <div ref={contentRef} className="opacity-0">
            <h2 className="text-hero-subtitle font-semibold font-raleway text-5xl mb-6">Contact Us</h2>
            ...
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-bold font-raleway text-md text-black underline">U.S. Office</h3>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <MapPin className="w-4 h-4 text-primary" />
                <h3 className="font-bold font-raleway text-md text-black underline">India Office</h3>
              </div>
              <p className="text-black font-normal text-sm font-manrope tracking-normal">
          ...
          <div ref={formRef} className="opacity-0 ">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="relative z-10">
                <h3 className="text-2xl font-bold font-raleway text-gray-900 mb-6">Get in Touch</h3>
                ...
                <motion.button
                  whileHover={{ scale: 1.02, boxShadow: "0 10px 25px -5px rgba(59, 130, 246, 0.25)" }}
                  whileTap={{ scale: 0.98 }}
                  type="submit"
